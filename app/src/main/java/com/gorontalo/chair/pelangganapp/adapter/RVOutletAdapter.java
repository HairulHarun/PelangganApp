...
public class RVOutletAdapter extends RecyclerView.Adapter<RVOutletAdapter.ViewHolder> {
    ...
    public RVOutletAdapter(Context context, List<OutletModel> list, double latitude, double longitude, String lokasi){
        super();
    ...
    @Override
    public RVOutletAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
